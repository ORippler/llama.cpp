...
GGML_API void dequantize_row_nvfp4_scaled(const block_nvfp4 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k, float scale);
...
GGML_API size_t quantize_nvfp4(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix, float * GGML_RESTRICT scales_out);
